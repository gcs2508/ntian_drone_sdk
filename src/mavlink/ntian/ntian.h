/** @file
 *	@brief MAVLink comm protocol generated from ntian.xml
 *	@see http://mavlink.org
 */
#ifndef MAVLINK_NTIAN_H
#define MAVLINK_NTIAN_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_NTIAN.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
...
// MESSAGE DEFINITIONS
#include "./mavlink_msg_mount_gimbal_control.h"
